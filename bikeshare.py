...
def get_filters():
    ...
    Returns:
        (str) city - name the city to analyze
        (str) month - name the month to filter by, or "all" to apply no month filter
    ...
    # take user input for day of week (all, monday, tuesday, ... sunday)
    while True:
        day = input(
